...
const CORE_RULES = [repositoryRule, documentationRule, dependenciesRule, maintenanceRule, hygieneRule];
export const RULE_PACKS = [
  { id: "core", version: 1, description: "Generic repository, documentation, dependency, maintenance, and hygiene checks.", rules: CORE_RULES },
...
export function rulesForPacks(packs, disabledRules) {
